...
def resize(w, h, expected_height, image_min_width, image_max_width): # đưa về size chuẩn
...
def process_image(image, image_height, image_min_width, image_max_width): # đưa về size chuẩn
